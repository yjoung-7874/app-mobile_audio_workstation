...
import Row from "MobileAudioWorkstation/src/components/row";
import PropsScreen from "MobileAudioWorkstation/component/workstation/PropsScreen";
import RunScreen from "MobileAudioWorkstation/component/workstation/RunScreen";
import LogicScreen from "MobileAudioWorkstation/component/workstation/LogicScreen";
import StateScreen from "MobileAudioWorkstation/component/workstation/StateScreen";
import CodeScreen from "MobileAudioWorkstation/component/workstation/CodeScreen";
import data from "MobileAudioWorkstation/component/workstation/data";
...
export default class Workstation extends Component {
  ...
  state = {
    state: data.state,           // states declared by user
    components: data.components, // components added by user
    logics: {
      componentDidMount: {
        ...
        return (
          ...
          >
            {component.text.type == "state" ? 
              (this.state.state.filter(state => state.name == component.text.value)[0].value) :
      ...
      case "Switch":
        return (
          <View style={{ flexDirection: "row" }}>
            <Switch
              value={component.value.type == "state" ? false : component.value.value}
            />
            <Text
              style={{
                fontSize: component.fontSize.value,
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.tabbar}>
          <TouchableOpacity
            style={[
              styles.tabbarButton, this.state.showTabScreen == "VIEW" ? styles.tabbarButtonActive : null
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.tabbarButton, this.state.showTabScreen == "LOGIC" ? styles.tabbarButtonActive : null
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.tabbarButton, this.state.showTabScreen == "STATE" ? styles.tabbarButtonActive : null
            ]}
        ...
        >
          {this.state.showRunScreen ? (
            <Image
              source={require("MobileAudioWorkstation/assets/stop.png")}
              style={styles.buttonFabIcon}
            />
          ) : (
            <Image
              source={require("MobileAudioWorkstation/assets/play.png")}
              style={styles.buttonFabIcon}
            />
          )}
        </TouchableOpacity>
        ...
        <TouchableOpacity
          style={[styles.buttonFab, { bottom: 110, right: 20 }]}
          onPress={() => this.setState({ showCodeScreen: true })}
        >
          <Image
            style={styles.buttonFabIcon}
            source={require("MobileAudioWorkstation/assets/code.png")}
          />
        </TouchableOpacity>
      </View>
    );
